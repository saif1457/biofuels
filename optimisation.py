...
efuels_vi.county = efuels_vi.county.str.replace(' CA','_CA')
efuels_vi.county = efuels_vi.county.str.replace(' TX','_TX')
efuels_vi.county = efuels_vi.county.str.replace(' MN','_MN')
